-- =====================================================
-- CAMPUSPANDIT - COMPLETE DATABASE MIGRATIONS v2.5
-- =====================================================
--
...
--
-- 📋 OPTIONAL (if you want a completely fresh start):
--    1. Run 00_DROP_ALL_TABLES.sql to drop all tables first
--    2. Then run this file (CONSOLIDATED_MIGRATIONS_FINAL.sql)
--
