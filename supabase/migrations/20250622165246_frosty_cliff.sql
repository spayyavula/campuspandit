/*
  # Fix user_role type error

  1. Changes
    - Safely check for existing types before creating them
    - Ensure all tables and policies are created properly
    - Maintain all the same functionality as the previous migration
  2. Security
    - Preserves all RLS policies
    - Maintains all permission settings
*/
